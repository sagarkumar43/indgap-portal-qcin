...
<head>
    ...
    <title>Buyer's View Details</title>
                    ...
                    <div class="container mt-5 mb-5">
                        ...
                        <div class="table-1" style="overflow: auto;">
                            <table class="table table-striped" id="example">
                                ...
                                <tbody>
                                    <?php
                                        $select = "SELECT * FROM `buyer_registration` ORDER BY ContactPersonName DESC LIMIT 5";
