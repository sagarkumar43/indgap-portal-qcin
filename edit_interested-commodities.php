...
$id = $_GET['editrecord'];
$select = "SELECT * FROM `buyer_interested_commodities` WHERE Id='$id'";
...
<body>
        ...
        <div class="container register-box mt-5 mb-5">
            <form method="POST">
                ...
                <div class="form-1">
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group mt-3">
                            <select class="selectpicker" aria-label="Default select example" data-live-search="true"
                                ...
                                <option value="<?php echo $read['Category']; ?>" selected><?php echo $read['Category']; ?></option>
                        ...
                        <div class="col-md-6 form-group mt-3">
                            ...
                            <select name="Commodities[]" class="form-control" multiple=""
                                ...
                                id="inputCategory">
                                <?php
                                    $subcate = explode(",",$read['Commodities']);
                                    foreach($subcate as $commodity)
                                    {
                                ?>
                    ...
                    <div class="text-right pt-4">
                        ...
                        <input type="submit" value="Update" class="btn btn-success" name="AddIntereste">
                    </div>
            </form>
            ...
            <?php
                    if(isset($_POST['AddIntereste']))
                    {
                        ...
                        $interested = "UPDATE `buyer_interested_commodities` SET Category='$Category',Commodities='$Commodities',Buyer_Registration_ID='$Buyer_Registration_ID' WHERE Id='$id'";
    ...
    <script>
        ...
        var Cereals = ["Maize", "Barley", "Millet", "Oat", "Rice", "Rye And Triticale", "Sorghum", "Wheat"];
