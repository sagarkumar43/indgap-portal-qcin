      ...
      <div class="container mt-5 mb-5">
         ...
         <div class="form-1">
            ...
            <form method="POST" enctype="multipart/form-data" autocomplete="off">
                    <h4 class="heading-text mt-3 mb-3 fb">Application Reviewer</h4>
                    <h5 class="heading-text mt-3 mb-3 fb"><strong>Signed Application form</strong></h5>
                    ...
                    <h5 class="heading-text mt-3 mb-3 fb"><strong>Review Report</strong></h5>
                    <div class="sprt-box pb-5">
                        <div class="row">
                            <div class="col-md-6 form-group mt-3">
                                <label class="mb-2">Document Upload</label>
                    ...
                    <h5 class="heading-text mt-3 mb-3 fb"><strong>Offer Letter</strong></h5>
                    <div class="sprt-box pb-5">
                        <div class="row">
                            <div class="col-md-6 form-group mt-3">
                                <label class="mb-2">Document Upload</label>
                    ...
                    <h5 class="heading-text mt-3 mb-3 fb"><strong>Sub-license Certification</strong></h5>
                    <div class="sprt-box pb-5">
                        <div class="row">
                            <div class="col-md-6 form-group mt-3">
                                <label class="mb-2">Document upload</label>
                    ...
                    <h4 class="heading-text mt-3 mb-3 fb">Scheduling</h4>
                    <h5 class="heading-text mt-3 mb-3 fb"><strong>Assessment Schedule</strong></h5>
                    <div class="sprt-box pb-5">
                        <div class="row">
                            <div class="col-md-6 form-group mt-3">
