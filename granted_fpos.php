         ...
         <div class="container mt-5 mb-5">
            ...
            <div class="table-1">
               <table class="table table-bordered">
                  ...
                  <tbody>
                     <?php
                        $query = mysqli_query($db, "SELECT FPR.*,cb_user_edit_fpo_profile.* FROM fpo_registration FPR INNER JOIN cb_user_edit_fpo_profile ON cb_user_edit_fpo_profile.FPO_Registration_ID = FPR.FPO_Registration_ID WHERE cb_user_edit_fpo_profile.Status_of_IndGAP='Granted' AND cb_user_edit_fpo_profile.Deleted_Status='0' ORDER BY cb_user_edit_fpo_profile.ID DESC");
                        $count = 1;
