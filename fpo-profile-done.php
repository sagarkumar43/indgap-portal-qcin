...
if (isset($_POST["Submit"])) {
    $GrossRevenue_Year = implode(",", $_POST["GrossRevenue_Year"]);
    $GrossRevenue_CropName = implode(",", str_replace(',', '', $_POST['GrossRevenue_CropName']));
    $GrossRevenue_CropVariety = implode(",", $_POST["GrossRevenue_CropVariety"]);
    $GrossRevenue_QuantityMT = implode(",", $_POST["GrossRevenue_QuantityMT"]);
    $GrossRevenue_RevenueinLakhs = implode(",", $_POST["GrossRevenue_RevenueinLakhs"]);
    $GrossRevenue_MarketPlace = implode(",", $_POST["GrossRevenue_MarketPlace"]);
    $GrossRevenue_AveragePricePerMT = implode(",", $_POST["GrossRevenue_AveragePricePerMT"]);
    $query1 = "UPDATE `fpo_registration_details` SET `GrossRevenue_Year`='$GrossRevenue_Year', `GrossRevenue_CropName`='$GrossRevenue_CropName', `GrossRevenue_CropVariety`='$GrossRevenue_CropVariety', `GrossRevenue_QuantityMT`='$GrossRevenue_QuantityMT', `GrossRevenue_RevenueinLakhs`='$GrossRevenue_RevenueinLakhs', `GrossRevenue_MarketPlace`='$GrossRevenue_MarketPlace', `GrossRevenue_AveragePricePerMT`='$GrossRevenue_AveragePricePerMT' WHERE FPO_Registration_ID  = '$_SESSION[FPO_Registration_ID]'";
    $exe_q = mysqli_query($db, $query1);
    if ($exe_q == TRUE) {
        header("Location:fpo-profile-done1.php");
    } else {
        header("Location:fpo-profile-done.php?msg=fail");
    }
}
?>
<!DOCTYPE html>
         ...
         <main id="main">
            ...
            <section>
               ...
               <form method="POST" action="">
                ...
                <?php
                $query2 = mysqli_query($db, "SELECT * from fpo_registration_details where FPO_Registration_ID  = '$_SESSION[FPO_Registration_ID]' AND GrossRevenue_CropName != '' AND DeletedStatus='0'");
                $row2 = mysqli_num_rows($query2);
                if($row2 == '1'){
                $rows2 = mysqli_fetch_assoc($query2);
                $rows2_GrossRevenue_CropName = $rows2['GrossRevenue_CropName'];
                $array2 = explode(',', $rows2_GrossRevenue_CropName);
                $array3 = explode(',', $rows2['GrossRevenue_Year']);
                $array4 = explode(',', $rows2['GrossRevenue_CropVariety']);
                $array5 = explode(',', $rows2['GrossRevenue_QuantityMT']);
                $array6 = explode(',', $rows2['GrossRevenue_RevenueinLakhs']);
                $array7 = explode(',', $rows2['GrossRevenue_MarketPlace']);
                $array8 = explode(',', $rows2['GrossRevenue_AveragePricePerMT']);
                $count = 1;
                foreach($array2 as $value2){
                ?>
                <div class="container" id="employee_table">
                  <div class="row" id="<?php if($count > 1){echo 'row2';}else{echo 'row1';}?>">
                     <div class="col-md-4 form-group mt-3">
                        <label class="mb-2" style="float: left;">Crop Name</label>
                        <input value="<?php echo $array2[$count-1];?>" name="GrossRevenue_CropName[]"
                           type="text" placeholder="Crop Name" />
                     </div>
                     <div class="col-md-4 form-group mt-3">
                        <label class="mb-2" style="float: left;">Year</label>
                        <select class="form-control" name="GrossRevenue_Year[]"
                           style="height: 50px;margin-top: 40px !important;">
                           <option value="">Select</option>
                           <option <?php if($array3[$count-1] == '2015'){echo "selected";} ?> value="2015">2015</option>
                           <option <?php if($array3[$count-1] == '2016'){echo "selected";} ?> value="2016">2016</option>
                           <option <?php if($array3[$count-1] == '2017'){echo "selected";} ?> value="2017">2017</option>
                           <option <?php if($array3[$count-1] == '2018'){echo "selected";} ?> value="2018">2018</option>
                           <option <?php if($array3[$count-1] == '2019'){echo "selected";} ?> value="2019">2019</option>
                           <option <?php if($array3[$count-1] == '2020'){echo "selected";} ?> value="2020">2020</option>
                           <option <?php if($array3[$count-1] == '2021'){echo "selected";} ?> value="2021">2021</option>
                           <option <?php if($array3[$count-1] == '2022'){echo "selected";} ?> value="2022">2022</option>
                           <option <?php if($array3[$count-1] == '2023'){echo "selected";} ?> value="2023">2023</option>
                           <option <?php if($array3[$count-1] == '2024'){echo "selected";} ?> value="2024">2024</option>
                           <option <?php if($array3[$count-1] == '2025'){echo "selected";} ?> value="2025">2025</option>
                           <option <?php if($array3[$count-1] == '2026'){echo "selected";} ?> value="2026">2026</option>
                           <option <?php if($array3[$count-1] == '2027'){echo "selected";} ?> value="2027">2027</option>
                           <option <?php if($array3[$count-1] == '2028'){echo "selected";} ?> value="2028">2028</option>
                           <option <?php if($array3[$count-1] == '2029'){echo "selected";} ?> value="2029">2029</option>
                           <option <?php if($array3[$count-1] == '2030'){echo "selected";} ?> value="2030">2030</option>
                        </select>
                     </div>
                     <div class="col-md-4 form-group mt-3">
                        <label class="mb-2" style="float: left;">Crop Variety</label>
                        <input value="<?php echo $array4[$count-1];?>" name="GrossRevenue_CropVariety[]"
                           type="text" placeholder="Crop variety" />
                     </div>
                     <div class="col-md-4 form-group mt-3">
                        <label class="mb-2" style="float: left;">Quantity (MT)</label>
                        <input value="<?php echo $array5[$count-1];?>" name="GrossRevenue_QuantityMT[]"
                           type="number" placeholder="Quantity (MT)" />
                     </div>
                     <div class="col-md-4 form-group mt-3">
                        <label class="mb-2" style="float: left;">Revenue (in Lakhs)</label>
                        <input value="<?php echo $array6[$count-1];?>" name="GrossRevenue_RevenueinLakhs[]" type="text" placeholder="Revenue (in Lakhs)" />
                     </div>
                     <div class="col-md-4 form-group mt-3">
                        <label class="mb-2" style="float: left;">Market Place</label>
                        <input value="<?php echo $array7[$count-1];?>" name="GrossRevenue_MarketPlace[]"
                           type="text" placeholder="Market Place" />
                     </div>
                     <div class="col-md-4 form-group mt-3">
                        <label class="mb-2" style="float: left;">Average Price Per MT</label>
                        <input value="<?php echo $array8[$count-1];?>" name="GrossRevenue_AveragePricePerMT[]" type="text" placeholder="Average Price" />
                     </div>
                     <?php if($count == 1){?>
                     <div class="col-md-4 form-group mt-5">
                        <input type="button" class="btn btn-success" onclick="add_gross();" value="+" style="width: 25%;">
                     </div>
                     <?php }?>
                     <?php if($count > 1){?>
                     <div class="col-md-4 form-group mt-5">
                        <input type="button" class="btn btn-danger mt-3" value="-" onclick="delete_gross('row2')" style="width: 25%;">
                     </div>
                     <?php }?>
                  </div>
               </div>
                ...
                <div class="container" id="employee_table">
                  <div class="row" id="row1">
                     <div class="col-md-4 form-group mt-3">
                        <label class="mb-2" style="float: left;">Crop Name</label>
                        <input value="" name="GrossRevenue_CropName[]"
                           type="text" placeholder="Crop Name" />
                     </div>
                     <div class="col-md-4 form-group mt-3">
                        <label class="mb-2" style="float: left;">Year</label>
                     ...
                     <div class="col-md-4 form-group mt-3">
                        <label class="mb-2" style="float: left;">Crop Variety</label>
                        <input value="" name="GrossRevenue_CropVariety[]"
                           type="text" placeholder="Crop variety" />
                     </div>
                     <div class="col-md-4 form-group mt-3">
                        <label class="mb-2" style="float: left;">Quantity (MT)</label>
                        <input value="" name="GrossRevenue_QuantityMT[]"
                           type="number" placeholder="Quantity (MT)" />
                     </div>
                     <div class="col-md-4 form-group mt-3">
                        <label class="mb-2" style="float: left;">Revenue (in Lakhs)</label>
                        <input value=""
                           name="GrossRevenue_RevenueinLakhs[]" type="text" placeholder="Revenue (in Lakhs)" />
                     </div>
                     <div class="col-md-4 form-group mt-3">
                        <label class="mb-2" style="float: left;">Market Place</label>
                        <input value="" name="GrossRevenue_MarketPlace[]"
                           type="text" placeholder="Market Place" />
                     </div>
                     <div class="col-md-4 form-group mt-3">
                        <label class="mb-2" style="float: left;">Average Price Per MT</label>
                        <input value=""
                           name="GrossRevenue_AveragePricePerMT[]" type="text" placeholder="Average Price" />
                     </div>
                     <div class="col-md-4 form-group mt-5">
                        <input type="button" class="btn btn-success" onclick="add_gross();" value="+" style="width: 25%;">
                     </div>
