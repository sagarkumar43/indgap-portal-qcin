                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
                                <h4 class="mb-0 text-gray -800">Add Assign</h4>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane show active" id="scroll-horizontal-preview">
                                            <form method="POST" autocomplete="off">
                                                <div class="row">
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <?php
                                                        $FPO_exe1 = mysqli_query($db,"SELECT * from `fpo_user_to_assign_cb` where `DeletedStatus` ='0'");
                                                        ...
                                                        <select class="form-control selectpicker" name="FPO_User[]" multiple
                                                            ...
                                                            <option
                                                                ...
                                                                <?php echo $FpoUser['FPOExporterName'] ?> - (<?php echo $FpoUser['FPO_UniqueCode'] ?>) 
                                                            </option>
                                                            <?php } ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-12 mt-3 text-start">
                                                        <input type="submit" name="save"
                                                            class="btn btn-primary fs-5 rounded-pill" value="Add">
                                                    </div>
                                                </div>
                                            </form>
                                            <?php 
                                            if( $_POST['FPO_User'] != '' AND $_POST['CB_User'] != '')
                                            {
                                                ...
                                                $assign_user = "INSERT INTO `fpo_user_to_assign_cb` (`User_Assing_ID`, `FPO_User_ID`, `CB_User`, `DeletedStatus`, `CreatedDate`) VALUES (NULL, '$fpo', '$cb', '0', current_timestamp())";

                                               $execute = mysqli_query($db,$assign_user);
                                               if($execute == TRUE)
                                               {
                                                    echo "<script>alert('User Assign Successfully')</script>";
