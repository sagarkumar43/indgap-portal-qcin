                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
                                <h4 class="mb-0 text-gray -800">Add New CB Account</h4>
                                <a href="CB_Accounts.php"
                                ...
                                <div class="card-body">
                                    <div class="tab-content">
                                        <div class="tab-pane show active" id="scroll-horizontal-preview">
                                            <form method="POST" autocomplete="off">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <input type="text" name="cb_mobile" class="form-control"
                                                            placeholder="Enter Mobile Number" required>
                                                    </div>
                                                    <div class="col-md-6 mt-2">
                                                        <label class="form-label">Email</label>
                                                        <input type="email" name="cb_email" class="form-control"
                                                            placeholder="Enter Email ID" required>
                                                    </div>
                                                    <div class="col-md-6 mt-2">
                                                        <label class="form-label">Password</label>
                                                        <div class="input-group input-group-merge">
                                                            <input type="password" id="password" name="cb_password"
                                            ...
                                            <?php 
                                            if( $_POST['cb_name'] != '' AND $_POST['cb_mobile'] != '' AND $_POST['cb_email'] != '' AND $_POST['cb_password'])
                                            {
                                                $name = $_POST['cb_name'];
                                                $mobile = $_POST['cb_mobile'];
                                                $email = $_POST['cb_email'];
                                                $password = md5($_POST['cb_password']);

                                                $expot = "INSERT INTO `cb_users` (`cb_user_id`, `Name`, `Email`, `Mobile`, `Password`, `DeletedStatus` ,`CreatedDate`) VALUES (NULL, '$name', '$email', '$mobile', '$password', '0' ,current_timestamp())";

                                               $execute = mysqli_query($db,$expot);
                                               if($execute == TRUE)
                                               {
                                                    echo "<script>alert('Add CB user Successfully')</script>";
                                                    echo "<script>window.location.href = 'CB_Accounts.php'</script>";
                                               }
                                               else
                                               {
