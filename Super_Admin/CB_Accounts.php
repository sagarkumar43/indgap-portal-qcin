                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
                                    <h4 class="mb-0 text-gray -800">CB User Lists</h4>
                                    <a href="add_new_user.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Add New</a>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="scroll-horizontal-preview">
                                                <table id="scroll-horizontal-datatable" class="table table-striped w-100 nowrap">
                                                    ...
                                                    <tbody>
                                                      <?php 
                                                        $export = "SELECT * FROM `cb_users` WHERE DeletedStatus='0' ORDER BY `cb_user_id` DESC";
