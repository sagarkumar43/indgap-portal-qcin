    ...
    <main id="main">
        ...
        <div class="container mb-5" style="height: 330px;overflow: auto;">
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                        $select = "SELECT Farmer_Id ,FPO_Registration_ID,FileName,CreatedDate FROM `farmers` WHERE FileName NOT IN('Manual Entry') AND FPO_Registration_ID='$_SESSION[FPO_Registration_ID]' ORDER BY FileName";
                    ...
                    <tr>
                        ...
                        <td>
                            <a onclick="return confirm('Are you sure want to Delete ?')" href="farmer_csv_file_delete.php?filename=<?php echo $read['FileName']; ?>"><input type="button" class="btn btn-danger" value="Delete" style="width: 130px;margin-left: 30px;"></a>
                        </td>
                    </tr>
                    <?php $count++; } ?>
                </tbody>
