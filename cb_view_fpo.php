...
$cbprofile = "SELECT * FROM `cb_users` WHERE DeletedStatus='0'";
$execute = mysqli_query($db,$cbprofile);
$read = mysqli_fetch_assoc($execute);
$FPO_Registration_ID = $_GET['id'];
$query_r = mysqli_query($db, "SELECT * from `cb_user_edit_fpo_profile` WHERE FPO_Registration_ID = '$FPO_Registration_ID' AND CB_User = '$_SESSION[cb_Name]' AND CB_User_Email = '$_SESSION[cb_Email]' AND CB_User_Phone = '$_SESSION[cb_Mobile]' AND Deleted_Status = '0'");
$row_num = mysqli_num_rows($query_r);
?>
<!DOCTYPE html>
<html lang="en">
...
<body style="background-image: url('images/fpo-bg2.jpg');background-repeat: repeat-y;background-position: center;">
    ...
    <main id="main">
        ...
        <div class="container mt-5 mb-5">
            ...
            <div class="table-1">
                <?php
                $query1 = mysqli_query($db, "SELECT * from `fpo_registration` where `DeletedStatus` ='0' AND FPO_Registration_ID ='$FPO_Registration_ID'");
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="border p-3 mb-3">
                                <div><strong>FPO Name</strong></div>
                                <div>
                                    <?php echo $row1['FPOExporterName']; ?>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                ...
                $query2 = mysqli_query($db, "SELECT * from `cb_user_edit_fpo_profile` WHERE FPO_Registration_ID = '$FPO_Registration_ID' AND CB_User = '$_SESSION[cb_Name]' AND CB_User_Email = '$_SESSION[cb_Email]' AND CB_User_Phone = '$_SESSION[cb_Mobile]' AND Deleted_Status = '0'");
                $row2 = mysqli_fetch_assoc($query2);
                     
                    ?>
                <div class="sprt-box">
                    <div class="row">
                        <h4 class="heading-text mt-3 mb-3"><strong>Application
