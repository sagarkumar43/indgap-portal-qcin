        ...
        <div class="container mt-5 mb-5">
            ...
            <div class="form-1">
                ...
                <form method="POST" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <h4 class="heading-text mt-3 mb-3 fb">Quality Manager</h4>

                    <h5 class="heading-text mt-3 mb-3 fb"><strong>Registration Certificate</strong></h5>
                    ...
                    <h5 class="heading-text mt-3 mb-3 fb"><strong>Residue analysis Report</strong></h5>
                    <div class="sprt-box pb-5">
                        <div class="row">
                            <div class="col-md-6 form-group mt-3">
                                <label class="mb-2">Document upload</label>
                    ...
                    <h5 class="heading-text mt-3 mb-3 fb"><strong>Certification Decision Report</strong></h5>
                    <div class="sprt-box pb-5">
                        <div class="row">
                            <div class="col-md-6 form-group mt-3">
                                <label class="mb-2">Document upload</label>
                    ...
                    <h5 class="heading-text mt-3 mb-3 fb"><strong>Scope Certificate</strong></h5>
                    <div class="sprt-box pb-5">
                        <div class="row">
                            <div class="col-md-6 form-group mt-3">
                    ...
                    <h5 class="heading-text mt-3 mb-3 fb"><strong>Feed Back</strong></h5>
                    <div class="sprt-box pb-5">
                        <div class="row">
                            <div class="col-md-6 form-group mt-3">
                                <label class="mb-2">Document upload</label>
                    ...
                    <h5 class="heading-text mt-3 mb-3 fb"><strong>Complaints</strong></h5>
                    <div class="sprt-box pb-5">
                        <div class="row">
                            <div class="col-md-6 form-group mt-3">
                                <label class="mb-2">Document upload</label>
                    ...
                    <h5 class="heading-text mt-3 mb-3 fb"><strong>Mass Balance Register</strong></h5>
                    <div class="sprt-box pb-5">
                        <div class="row">
                            <div class="col-md-6 form-group mt-3">
                                <label class="mb-2">Document upload</label>
                    ...
                    <h5 class="heading-text mt-3 mb-3 fb"><strong>Internal Folder</strong></h5>
                    <div class="sprt-box pb-5">
                        <div class="row">
                            <div class="col-md-6 form-group mt-3">
                            ...
                            <div class="col-md-6 form-group mt-3">
                                <label class="mb-2">Organogram</label>
                                <input value="" type="text" name="" class="form-control" placeholder="">
                            </div>
                        </div>
                    </div>
