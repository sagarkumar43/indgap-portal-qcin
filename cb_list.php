...
<body style="background-image: url('images/fpo-bg2.jpg');background-repeat: repeat-y;background-position: center;">
        ...
        <div class="container mt-5 mb-5">
            ...
            <div class="table-1">
                <div class="col-md-4 text-center">
                    <select name="cb_list" id="cb_list" class="form-control mb-5" onChange="SelectRedirect();">
    ...
    <script>
        function SelectRedirect() {
            ...
            switch (document.getElementById('cb_list').value) {
                case "DPS":
                    window.location = "qci_profile.php";
                    break;
