...
<body>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-floating">
                            <select name="od" class="form-control" required="" id="compliances">
                                <option value="compliances">--Select Standard--</option>
    ...
    <div class="container-xxl py-5" style="padding-top: 0rem !important;padding-bottom: 0rem !important; background-color:#f6f6f6;">
         <div class="container">
            <div class="col-md-12 text-center"><img src="assets/img/coming-soon-img.png"></div>
         </div>
      </div> 
