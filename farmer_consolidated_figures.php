                  ...
                  <div class="col-lg-12">
                     <div class="bs-component">
                        <div class="alert alert-dismissible alert-danger" style="width: 50%;">
                           <button class="close" type="button" data-dismiss="alert" style="float: right;">×</button>Cluster
               ...
               <table class="table table-bordered">
                  <thead>
                     <tr>
                        ...
                        <th>Grade</th>
                        <th>Sowing Months</th>
                        <th>Marketable Surplus In MT</th>
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td><?php echo $read['VillageName']; ?></td>
                        <td><?php echo $read['No_of_Villagers']; ?></td>
                        <td><?php echo $read['CropType']; ?></td>
                        <td><?php echo $read['CropSeason']; ?></td>
                        <td><?php echo $read['CropName']; ?></td>
                        <td><?php echo $read['Grade']; ?></td>
                        <td><?php echo $read['ShowingMonth']; ?></td>
                        <td><?php echo $read['Marketable_Surplus_In_MT']; ?></td>
                        <td><?php echo $read['Land_Under_Cultivation_in_Ha']; ?></td>
                        <td><?php echo $read['Appoximate_Yield_per_Ha_in_MT']; ?></td>
                     </tr>
                     <?php $count++; } ?>
                  </tbody>
               </table>
