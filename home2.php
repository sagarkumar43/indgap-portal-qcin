         ...
         <div class="contents order-2 order-md-1">
            <div class="container">
               <div class="row align-items-center justify-content-center">
                  <div class="col-md-8">
                     <div class="mb-4">
                        <h3>CB & QCI E-INTERFACE</h3>
                        <p class="mb-4">Welcome back CB & QCI E-Interface.</p>
                     </div>
                     <h3>Are You?</h3>
                     <a href="qci-login.php" class="btn btn-primary">QCI</a>
                     <a href="cb-login.php" class="btn btn-success">CB</a>
