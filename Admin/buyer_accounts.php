...
<head>
        <meta charset="utf-8" />
        <title>Buyer Inactive Users</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
                                    <h4 class="mb-0 text-gray -800">Buyer Inactive Users</h4>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <abbr title="Make Inactive"><a
                                                                    ...
                                                                    href="buyer_inactive_status.php?BuyerInactive=<?php echo $read['Buyer_Registration_ID']; ?>"><button
                                                            ...
                                                            <abbr title="Make Active"><a
                                                                    ...
                                                                    href="buyer_active_status.php?BuyerActive=<?php echo $read['Buyer_Registration_ID']; ?>"><button
