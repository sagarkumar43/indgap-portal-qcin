                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">About Website</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            ...
                                            <table class="table table-striped table-centered mb-0">
                                                ...
                                                <tbody>
                                                <?php 
                                                            $about = "SELECT * FROM `about_website`";
                                                    ...
                                                    <tr>
                                                            ...
                                                            <td><?php echo $read['Heading']; ?></td>
                                                            <td class="whitespace-nowrap" style="text-align: justify;"><?php echo $read['details']; ?></td>
                                                            <td>
                                                                <abbr title="Edit"><a href="edit_about_homepage.php"><button type="button" class="btn btn-success"><i class="mdi mdi-grease-pencil"></i> </button></a></abbr>
