...
<head>
    <meta charset="utf-8" />
    <title>Edit About Home Page</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Edit About Home Page</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                    <div class="container">
                        <div class="main-body">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <?php 
                                        $select = "SELECT * FROM `about_website`";
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row mb-3">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input type="text" value="<?php echo $read['Heading'] ?>" class="form-control" name="title" required="">
                                                    </div>
                                                </div>
                                                <div class="row mb-3 mt-3">
                                                    <div class="col-sm-12">
                                                        <h4 class="mb-2">About Details</h4>
                                                    </div>
                                                    <div class="col-sm-12">
                                                            <textarea name="about-details" id="editor1" cols="30" rows="10"><?php echo $read['details']; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-12">
                                    ...
                                    <?php
                                        if(isset($_POST['save']))
                                        {
                                            $about = $_POST['about-details'];
                                            $title = $_POST['title'];

                                            $update = "UPDATE `about_website` SET details='$about',Heading='$title'";
                                            $execute = mysqli_query($db,$update);
                                            if ($execute == TRUE) {
                                                echo "<script>alert('Update Successfully')</script>";
                                                echo "<script>window.location.href = 'about_homepage.php';</script>";
                                            }
                                            else
                                            {
