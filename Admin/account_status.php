                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title">Account Status</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="scroll-horizontal-preview">
                                                <div class="col-md-12 text-center">
                                                   <a href="fpo_accounts.php" class="btn btn-primary rounded-pill">FPO Users</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="scroll-horizontal-preview">
                                                <div class="col-md-12 text-center">
                                                    <a href="cluster_accounts.php" class="btn btn-success rounded-pill">Cluster Users</a>
                                                </div>
                                            </div> 
                                        </div> 
                                    </div> 
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="scroll-horizontal-preview">
                                                <div class="col-md-12 text-center">
                                                    <a href="buyer_accounts.php" class="btn btn-info rounded-pill">Buyer Users</a>
                                                </div>
                                            </div> 
                                        </div> 
                                    </div> 
