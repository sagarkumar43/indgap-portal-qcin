                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
                                    <h4 class="mb-0 text-gray -800">Export</h4>
                                    <a href="add_export_doc.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Add New</a>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="scroll-horizontal-preview">
                                                <table id="scroll-horizontal-datatable" class="table table-striped w-100 nowrap">
                                                    ...
                                                    <tbody>
                                                      <?php 
                                                        $export = "SELECT * FROM `export_document` WHERE DeletedStatus='0' ORDER BY `Id` DESC";
                                                        $execute = mysqli_query($db,$export);
                                                        $count = 1;
                                                      ...
                                                      ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $read['Standard']; ?></td>
                                                            <td><?php echo $read['Country']; ?></td>
                                                            <td><?php echo $read['Doc_Name']; ?></td>
                                                            <td><a href="../ExportDocuments/export/<?php echo $read['Document']; ?>" target="_blank" rel="noopener noreferrer"><img src="../images/download.png" style="width:40px; text-align: center;"></a></td>
                                                            <td><?php echo $read['Doc_Source']; ?></td>
                                                            <td>
                                                                <a href="<?php echo $read['Source_Link']; ?>" target="_blank"><?php echo $read['Source_Link']; ?></a>
                        
                                                            </td>
                                                            <td>
                                                                <abbr title="Edit"><a href="edit_export_doc.php?id=<?php echo $read['Id']; ?>" onclick="return confirm('Are you sure you want Edit this record ?')"><button type="button" class="btn btn-success"><i class="mdi mdi-grease-pencil"></i> </button></a></abbr>
                                                                
                                                                <abbr title="Delete"><a href="delete_export_doc.php?delete=<?php echo $read['Id']; ?>" onclick="return confirm('Are you sure you want Delete this record ?')"><button type="button" class="btn btn-danger"><i class="mdi mdi-trash-can"></i> </button></a></abbr>
                                                            </td>
                                                        </tr>
                                                       <?php $count++; } ?>
                                                    </tbody>
