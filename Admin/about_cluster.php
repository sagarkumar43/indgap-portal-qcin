                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">About Cluster</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            ...
                                            <table class="table table-striped table-centered mb-0">
                                                ...
                                                <tbody>
                                                <?php 
                                                            $about = "SELECT * FROM `about_cluster`";
                                                    ...
                                                    <tr>
                                                            ...
                                                            <td class="whitespace-nowrap" style="text-align: justify;"><?php echo $read['about_cluster']; ?></td>
                                                            <td>
                                                                <abbr title="Edit"><a href="edit_about_cluster.php"><button type="button" class="btn btn-success"><i class="mdi mdi-grease-pencil"></i> </button></a></abbr>
