                                ...
                                <div class="col-sm-3">
                                    <div class="card widget-flat">
                                        <div class="card-body">
                                            ...
                                            <?php
                                                $fpo ="SELECT COUNT(*) AS totalfpo FROM fpo_registration";
                                                $fpoexe = mysqli_query($db,$fpo);
                                                $read = mysqli_fetch_assoc($fpoexe);
                                            ?>
                                            <h5 class="text-muted fw-normal mt-0" title="Number of Customers">Total FPO
                                            </h5>
                                            <h3 class="mt-3 mb-3"><?php echo $read['totalfpo']; ?></h3>
                                ...
                                <div class="col-sm-3">
                                    <div class="card widget-flat">
                                        <div class="card-body">
                                            ...
                                            <?php
                                                $cluster ="SELECT COUNT(*) AS totalcluster FROM cluster_registration";
                                                $clusterexe = mysqli_query($db,$cluster);
                                                $read1 = mysqli_fetch_assoc($clusterexe);
                                            ?>
                                            <h5 class="text-muted fw-normal mt-0" title="Number of Orders">Total Cluster</h5>
                                            <h3 class="mt-3 mb-3"><?php echo $read1['totalcluster']; ?></h3>
                                            <!-- <p class="mb-0 text-muted">
                                ...
                                <div class="col-sm-3">
                                    <div class="card widget-flat">
                                        <div class="card-body">
                                            ...
                                            <?php
                                                $buyer ="SELECT COUNT(*) AS totalbuyer FROM buyer_registration";
                                                $buyerexe = mysqli_query($db,$buyer);
                                                $read2 = mysqli_fetch_assoc($buyerexe);
                                            ?>
                                            <h5 class="text-muted fw-normal mt-0" title="Number of Orders">Total Buyers</h5>
                                            <h3 class="mt-3 mb-3"><?php echo $read2['totalbuyer']; ?></h3>
                                            <!-- <p class="mb-0 text-muted">
                                                <span class="text-danger me-2"><i class="mdi mdi-arrow-down-bold"></i>
                                                    1.08%</span>
                                                <span class="text-nowrap">Since last month</span>
                                ...
                                <div class="col-sm-3">
                                    <div class="card widget-flat">
                                        <div class="card-body">
                                            ...
                                            <h5 class="text-muted fw-normal mt-0" title="Number of Orders">Growth</h5>
...
<!-- Mirrored from coderthemes.com/hyper_2/modern/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 11 Oct 2022 04:54:41 GMT -->
