                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">About FPO</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                            ...
                                            <table class="table table-striped table-centered mb-0">
                                                ...
                                                <?php 
                                                    ...
                                                    <tr>
                                                            ...
                                                            <td class="whitespace-nowrap" style="text-align: justify;"><?php echo $read['about_fpo']; ?></td>
                                                            <td>
                                                                <abbr title="Edit"><a href="edit_about_fpo.php"><button type="button" class="btn btn-success"><i class="mdi mdi-grease-pencil"></i> </button></a></abbr>
