...
<head>
        <meta charset="utf-8" />
        <title>Cluster Registered Users</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">Cluster Registered Users</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="scroll-horizontal-preview">
                                                <table id="scroll-horizontal-datatable" class="table table-striped w-100 nowrap">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                           $cluster = "SELECT * FROM `cluster_registration` ORDER BY Cluster_Registration_ID DESC";
                                                           $exe = mysqli_query($db, $cluster);
                                                           $count = 1;
                                                           while($read=mysqli_fetch_assoc($exe)){
                                                           $StartDate = date_create($read['RegistrationDate']);
                                                           $Date = date_format($StartDate,"d M Y");
                                                        ?>
                                                    <tr>
                                                        <td><?php echo $count; ?></td>
                                                        <td><?php echo $read['ClusterName']; ?></td>
                                                        <td><?php echo $read['ClusterAddress']; ?></td>
                                                        <td><?php echo $read['block_taluka_mandal']; ?></td>
                                                        <td><?php echo $read['State']; ?></td>
                                                        <td><?php echo $read['District']; ?></td>
                                                        <td><?php echo $read['ContactPerson']; ?></td>
                                                        <td><?php echo $read['ContactNo']; ?></td>
