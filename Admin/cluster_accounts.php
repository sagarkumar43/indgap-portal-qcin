...
<head>
    <meta charset="utf-8" />
    <title>Cluster Inactive Users</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
                                <h4 class="mb-0 text-gray-800">Cluster Inactive Users</h4>
                                <a href="account_status.php"
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane show active" id="scroll-horizontal-preview">
                                            <table id="scroll-horizontal-datatable"
                                                ...
                                                <tbody>
                                                    <?php
                                                            $fpo = "SELECT * FROM `cluster_registration` ORDER BY Cluster_Registration_ID DESC ";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php echo $read['ClusterName']; ?>
                                                        </td>
                                                        <td>
                                                            <?php if($read['Account_Status'] == "Inactive") { ?>
                                                            <?php echo $read['Account_Status']; ?> <span>&#128308;</span>
                                                            <?php } else {?>
                                                            <?php echo $read['Account_Status']; ?> <span>&#128994;</span>
                                                            <?php } ?>
                                                        </td>   
                                                        <td>
                                                            <?php if($read['Account_Status'] == "Active") { ?>
                                                            <abbr title="Make Inactive"><a
                                                                    onclick="return confirm('Are you sure you want Inactive this account ?')"
                                                                    href="cluster_inactive_status.php?ClusterInactive=<?php echo $read['Cluster_Registration_ID']; ?>"><button
                                                                        type="button" class="btn btn-success"><i
                                                                            class="mdi mdi-account-remove"></i>
                                                                            </button></a>
                                                            </abbr>
                                                            <?php } else {?>
                                                            <abbr title="Make Active"><a
                                                                    onclick="return confirm('Are you sure you want Active this account ?')"
                                                                    href="cluster_active_status.php?ClusterActive=<?php echo $read['Cluster_Registration_ID']; ?>"><button
                                                                        type="button" class="btn btn-danger"><i
                                                                            class="mdi mdi-account-plus"></i> </button></a>
                                                            </abbr>
                                                            <?php } ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $read['ClusterAddress']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $read['State']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $read['District']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $read['ContactPerson']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $read['Email']; ?>
                                                        </td>
                                                        <td>
                                                            <?php echo $read['ContactNo']; ?>
                                                        </td>
                                                        <td>
                                                            <a href="../ClusterRegistrationCertificates//<?php echo $read['RegistrationCertificates']; ?>"
