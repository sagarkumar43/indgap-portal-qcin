...
$id= $_GET['id'];
$select = "SELECT * FROM `export_document` WHERE Id='$id' AND DeletedStatus='0'";
                    ...
                    <div class="row">
                            <div class="col-md-12">
                                <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
                                    <h4 class="mb-0 text-gray -800">Edi Export Document</h4>
                                    <a href="admin_export.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Back</a>
                                </div>
                            </div>
                        </div>
                    <!-- end page title -->
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <select class="form-select" name="standard"  required>
                                                            <option value="<?php echo $read['Standard']; ?>" selected><?php echo $read['Standard']; ?></option>
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <select class="form-select" name="country"  required>
                                                            <option value="<?php echo $read['Country']; ?>" selected><?php echo $read['Country']; ?></option>
                                                            <option>Select</option>
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <input type="text" name="document_name" value="<?php echo $read['Doc_Name']; ?>" class="form-control" placeholder="">
                                                    </div>
                                                    <div class="col-md-6 mt-2">
                                                        <label class="form-label">Document Upload</label>
                                                        <input type="file" name="document" class="form-control">
                                                        <a href="../ExportDocuments/export/<?php echo $read['Document']; ?>" target="_blank" rel="noopener noreferrer"><img src="../images/download.png" style="width:40px; text-align: center;"></a>
                                                    </div>
                                                    <div class="col-md-6 mt-3">
                                                        <label class="form-label">Document Source</label>
                                                        <input type="text" name="source" value="<?php echo $read['Doc_Source']; ?>" class="form-control" placeholder="">
                                                    </div>
                                                    <div class="col-md-6 mt-3">
                                                        <label class="form-label">Source Link</label>
                                                        <input type="text" name="source_link" value="<?php echo $read['Source_Link']; ?>" class="form-control" placeholder="">
                                                    </div>
                                                    <div class="col-md-6"></div>
                                                    <div class="col-md-12 mt-3 text-start">
                                                        <input type="submit" name="save" class="btn btn-primary fs-5 rounded-pill" value="Update">
                                                    </div>
                                                </div>
                                            </form>
                                            <?php 
                                            if( $_POST['standard'] != '' AND $_POST['country'] != '' AND $_FILES['document'] != '')
                                            {
                                                ...
                                                move_uploaded_file($document_tmp,'../ExportDocuments/export/'.$document);
                                                }
                                                if($document == "")
                                                {
                                                  $new_document = $read['Document'];
                                                }
                                                else{
                                                ...
                                                $expot = "UPDATE `export_document` SET Standard='$standard',Country='$country',Doc_Name='$document_name',Document='$new_document',Doc_Source='$source',Source_Link='$source_link' WHERE Id='$id'";
                                               $execute = mysqli_query($db,$expot);
                                               if($execute == TRUE)
                                               {
                                               ...
                                               {
                                                    echo "<script>alert('Can't Update Try Again')</script>";
                                               }
                                            }
                                            ?>
                                        </div> <!-- end preview-->
