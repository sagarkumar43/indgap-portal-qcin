...
<head>
        <meta charset="utf-8" />
        <title>About Buyer Interface</title>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">About Buyer Interface</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                    ...
                                    <div class="card-body">
                                        <div class="tab-content">
                                            ...
                                            <table class="table table-striped table-centered mb-0">
                                                ...
                                                <tbody>
                                                <?php 
                                                            $about = "SELECT * FROM `about_buyer_interface`";
                                                            $exe = mysqli_query($db,$about);
                                                            $count = 1;
                                                    ...
                                                    <tr>
                                                            ...
                                                            <td class="whitespace-nowrap" style="text-align: justify;"><?php echo $read['about_buyer_interface']; ?></td>
                                                            <td>
                                                                <abbr title="Edit"><a href="edit_about_buyer_interface.php"><button type="button" class="btn btn-success"><i class="mdi mdi-grease-pencil"></i> </button></a></abbr>
