            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarEmail">
                    <ul class="side-nav-second-level">
                        <li>
                            <a href="about_homepage.php">About Webstie</a>
                        </li>
                        <li>
                            <a href="about_buyer_interface.php">About Buyer Interface</a>
                        </li>
                        <li>
                            <a href="about_fpo.php">About FPO</a>
                        </li>
                        <li><a href="about_cluster.php">About Cluster</a></li>
                    </ul>
                </div>
            </li>
