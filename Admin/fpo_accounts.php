...
<head>
    <meta charset="utf-8" />
    <title>FPO Inactive Users</title>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
                                <h4 class="mb-0 text-gray-800">FPO Inactive Users</h4>
                                <a href="account_status.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">Back</a>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane show active" id="scroll-horizontal-preview">
                                            <table id="scroll-horizontal-datatable"
                                                ...
                                                <tbody>
                                                    <?php
                                                            $fpo = "SELECT * FROM `fpo_registration` ORDER BY FPO_Registration_ID DESC ";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($read['Account_Status'] == "Active") { ?>
                                                                ...
                                                                <abbr title="Make Inactive"><a
                                                                    ...
                                                                    href="fpo_inactive_status.php?inactive=<?php echo $read['FPO_Registration_ID']; ?>"><button
                                                            ...
                                                            <?php } else {?>
                                                                ...
                                                                <abbr title="Make Active"><a
                                                                    ...
                                                                    href="fpo_active_status.php?active=<?php echo $read['FPO_Registration_ID']; ?>"><button
                                                        ...
                                                        <td>
                                                            <a href="../FPORegistrationCertificates/<?php echo $read['RegistrationCertificate']; ?>"
