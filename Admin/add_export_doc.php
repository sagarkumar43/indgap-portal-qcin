                    ...
                    <div class="row">
                            <div class="col-md-12">
                                <div class="d-sm-flex align-items-center justify-content-between mb-4 mt-4">
                                    <h4 class="mb-0 text-gray -800">Add Export Document</h4>
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane show active" id="scroll-horizontal-preview">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <select class="form-select" name="standard"  required>
                                                            ...
                                                            <option value="ExportInspectionCouncil">Export Inspection Council</option>
                                                            <option value="DirectorateofPlantProtection">Directorate of Plant Protection</option>
                                                    ...
                                                    <div class="col-md-6 mt-2">
                                                        ...
                                                        <input type="text" name="source_link" class="form-control" placeholder="">
                                                    </div>
                                                    <div class="col-md-6"></div>
                                                    <div class="col-md-12 mt-3 text-start">
                                                        <input type="submit" name="save" class="btn btn-primary fs-5 rounded-pill" value="Add">
                                                    </div>
                                                </div>
                                            </form>
                                            <?php 
                                            if( $_POST['standard'] != '' AND $_POST['country'] != '' AND $_FILES['document'] != '')
                                            {
                                                ...
                                                $expot = "INSERT INTO `export_document` SET Standard='$standard',Country='$country',Doc_Name='$document_name',Document='$document',Doc_Source='$source',Source_Link='$source_link',DeletedStatus='0'";
