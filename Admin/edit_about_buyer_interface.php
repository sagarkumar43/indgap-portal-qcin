                    ...
                    <div class="container">
                        <div class="main-body">
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    <?php 
                                        $select = "SELECT * FROM `about_buyer_interface`";
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="row mb-3 mt-3">
                                                    ...
                                                    <div class="col-sm-12">
                                                            <textarea name="about-details" id="editor1" cols="30" rows="10"><?php echo $read['about_buyer_interface']; ?></textarea>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-sm-12">
                                    ...
                                    <?php
                                        if(isset($_POST['save']))
                                        {
                                            ...
                                            $update = "UPDATE `about_buyer_interface` SET about_buyer_interface='$about'";
                                            $execute = mysqli_query($db,$update);
                                            if ($execute == TRUE) {
                                                echo "<script>alert('Update Successfully')</script>";
                                                echo "<script>window.location.href = 'about_buyer_interface.php';</script>";
                                            }
                                            else
                                            {
