                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    <h4 class="page-title">FPO Registered Users</h4>
                                </div>
                            </div>
                        </div>
                        <!-- end page title -->
                                                ...
                                                <table id="scroll-horizontal-datatable" class="table table-striped w-100 nowrap">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th>Crop Year</th>
                                                            <th>Crop Season</th>
                                                            <th>Projected Farm Output (MT)</th>
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        // SELECT F.*,R.* FROM `fpo_registration_crops_cultivated` F inner join fpo_registration R ON F.FPO_Registration_ID=R.FPO_Registration_ID;
                                                            $fpo = "SELECT F.*,R.* FROM `fpo_registration_crops_cultivated` F inner join fpo_registration R ON F.FPO_Registration_ID=R.FPO_Registration_ID ORDER BY F.FPO_Registration_ID DESC;";
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $read['CropsCultivated']; ?></td>
                                                            <td><?php echo $read['FPOExporterName']; ?></td>
                                                            <td><?php echo $read['Year']; ?></td>
                                                            <td><?php echo $read['Season']; ?></td>
                                                            <td><?php echo $read['ProjectFarmOutputMT']; ?></td>
                                                            <td><?php echo $read['Address']; ?></td>
                                                            
                                                            <td><?php echo $read['District']; ?></td>
                                                            <td><?php echo $read['State']; ?></td>
                                                            <td><?php echo $read['ContactPerson']; ?></td>
                                                            <td><?php echo $read['Landline']; ?></td>
                                                            <td><?php echo $read['Email']; ?></td>
                                                            
                                                            <td>
                                                            <a href="../FPORegistrationCertificates/<?php echo $read['RegistrationCertificate']; ?>" target="_blank"><img src="../images/download.png" style="width:40px; text-align: center;"></a>
                                                            </td>
                                                            
                                                            <td><?php echo $read['RsinLakhs']; ?></td>
