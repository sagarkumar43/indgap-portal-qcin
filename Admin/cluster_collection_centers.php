                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title text-center">Cluster Collection Center's</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                            ...
                                            <table id="scroll-horizontal-datatable"
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>State</th>
                                                        <th>District</th>
                                                        <th>Nearest Twon For Transport</th>
                                                        <th>Distance By Road To The Collection Canter</th>
                                                        <th>Goverment Mandi / Product Auction Location</th>
                                                        <th>Action</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <?php
                                                        $collection_center = "SELECT * FROM `cluster_collection_center` WHERE DeletedStatus=0";
                                                        $execute = mysqli_query($db,$collection_center);
                                                        $count = 1;
                                                        while($read = mysqli_fetch_assoc($execute))
                                                        {
                                                    ?>
                                                    <tr>
                                                        <td class="whitespace-nowrap"><?php echo $count; ?></td>
                                                        <td class="whitespace-nowrap"><?php echo $read['CollectionCenter']; ?></td>
                                                        <td class="whitespace-nowrap"><?php echo $read['State']; ?></td>
                                                        <td class="whitespace-nowrap"><?php echo $read['District']; ?></td>
                                                        <td class="whitespace-nowrap"><?php echo $read['NearestTwonForTransport']; ?></td>
                                                        <td class="whitespace-nowrap"><?php echo $read['DistanceByRoadToTheCOllectionCanter']; ?></td>
                                                        <td class="whitespace-nowrap"><?php echo $read['GovermentMandiProductAuctionLocation']; ?></td>
